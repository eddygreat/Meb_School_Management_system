  ...
  return (
    <div className="bg-gray-50 text-gray-800">
      ...
      <header className="shadow-md">
        <div className="container mx-auto px-6 py-4 text-xl flex justify-between items-center">
          ...
          <nav>
            ...
            <Link
              to="/signup"
              className="ml-4 px-4 py-2 sm:text-2xl md:text-3xl font-semibold text-white bg-blue-500 rounded-md hover:bg-blue-600"
            >
              Sign Up
            </Link>
          </nav>
      ...
      <main className="text-center py-20 px-6 bg-white">
        <h2 className="text-3xl font-extrabold tracking-tight text-gray-700 sm:text-4xl md:text-5xl">
          <span className="block">The Future of School Management</span>
          <span className="block text-blue-500">Starts Here.</span>
        </h2>
      ...
      <footer className="bg-white">
        <div className="container mx-auto px-6 py-4">
          <p className="text-center text-gray-500">
            &copy; {new Date().getFullYear()} MebEduPortal. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
