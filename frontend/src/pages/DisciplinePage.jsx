        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="text-left border-b">
              <th className="p-2">ID</th><th className="p-2">Student</th><th className="p-2">Category</th><th className="p-2">Status</th><th className="p-2">Actions</th>
            </tr>
          </thead>
          <tbody>
            {items.map(i => (
            ...
            {!items.length && <tr><td className="p-2 text-gray-500">No incidents</td><td colSpan={4}></td></tr>}
          </tbody>
        </table>
      </div>
    </div>
